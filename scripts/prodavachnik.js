function startApp() {
    ...
    function listAdsView() {
        $.get('./templates/ads.html')
            .then(function (data) {
                $.get('./templates/storeBox.html')
    ...
    function createAdView() {
        $.get('./templates/createAd.html')
            .then(function (data) {
                let form = $.get('./templates/create-edit-form.html')
                ...
                .then(function (data) {
                    let form = $.get('./templates/create-edit-form.html')
                        .then(function (formData) {
                            ...
                            let template = Handlebars.compile(data);
                            $('#main').html(template(contex));
                            // $('main #buttonEditAd').click(() => console.log("dsfdsf"))
